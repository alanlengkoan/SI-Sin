            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-datatable">
                        <table class="table table-striped table-bordered" id="tabel-guru-dt" style="width: 100%;">
                        </table>
                    </div>
                </div>
            </div>
    ...
    <div id="modal-add-upd" class="modal fade text-start" tabindex="-1" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <!-- begin:: untuk form -->
                <form id="form-add-upd" class="form form-horizontal" action="{{ route('guru.save') }}" method="POST">
                        ...
                        <div id="form-show">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="field-input mb-1 row">
                                        <div class="col-sm-3">
                                            <label class="col-form-label" for="id_matpel">Mata Pelajaran&nbsp;*</label>
                                        </div>
                                        <div class="col-sm-9">
                                            <select class="form-control form-control-sm" name="id_matpel" id="id_matpel">
                                                <option value="">Pilih</option>
                                                @foreach ($matpels as $row)
                                                <option value="{{ $row->id_matpel }}">{{ $row->nama }}</option>
                                                @endforeach
                                            </select>
                                            <div class="invalid-feedback"></div>
                                        </div>
            ...
            $(document).on('click', '#upd', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#id_matpel').val(response.id_matpel);
