<x-admin-layout title="{{ $title }}">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-datatable">
                        <table class="table table-striped table-bordered" id="tabel-informasi-dt" style="width: 100%;">
                        </table>
                    </div>
                </div>
            </div>
    ...
    <div id="modal-add-upd" class="modal fade text-start" tabindex="-1" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <!-- begin:: untuk form -->
                <form id="form-add-upd" class="form form-horizontal" action="{{ route('informasi.save') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="field-input mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control form-control-sm" id="judul" name="judul" placeholder="Masukkan judul informasi" />
                                            <div class="invalid-feedback"></div>
                                        </div>
                                    </div>
                                    <div class="field-input mb-1 row">
                                    ...
                                    <div class="field-input mb-1 row">
                                        <div class="col-sm-3">
                                            <label class="col-form-label" for="isi">Isi&nbsp;*</label>
                                        </div>
                                        <div class="col-sm-9">
    ...
    <script>
            ...
            setup: (editor) => {
                editor.on('change', () => {
                    if (editor.getContent() == '') {
                        $('#isi').removeClass('is-valid').addClass('is-invalid');
                    } else {
                        $('#isi').removeClass('is-invalid').addClass('is-valid');
                    }
                });
            },
        });
        ...
        let untukTabel = function() {
            table = $('#tabel-informasi-dt').DataTable({
                serverSide: true,
                responsive: true,
                processing: true,
                ...
                ajax: "{{ route('informasi.get_data_dt') }}",
            ...
            $(document).on('click', '#upd', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#id_informasi').val(response.id_informasi);
                        $('#id_kategori').val(response.id_kategori).trigger('change');
                        $('#judul').val(response.judul);
                        tinyMCE.activeEditor.setContent(response.isi);
