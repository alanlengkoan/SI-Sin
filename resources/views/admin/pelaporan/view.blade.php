<x-admin-layout title="{{ $title }}">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-datatable">
                        <table class="table table-striped table-bordered" id="tabel-pelaporan-dt" style="width: 100%;">
                        </table>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        let untukTabel = function() {
            table = $('#tabel-pelaporan-dt').DataTable({
                serverSide: true,
                responsive: true,
                processing: true,
                ...
                ajax: "{{ route('admin.pelaporan.get_data_dt') }}",
