...
class GuruRequest extends FormRequest
{
    ...
    public function messages()
    {
        ...
        $messages['id_matpel.required']     = 'Mata pelajaran harus diisi!';
        $messages['id_jabatan.required']    = 'Jabatan harus diisi!';
        $messages['id_pendidikan.required'] = 'Pendidikan harus diisi!';
        $messages['nip.required']           = 'NIP harus diisi!';
        $messages['nama.required']          = 'Nama harus diisi!';
        $messages['kelamin.required']       = 'Kelamin harus diisi!';
        $messages['tgl_lahir.required']     = 'Tanggal lahir harus diisi!';
        $messages['tmp_lahir.required']     = 'Tempat lahir harus diisi!';
